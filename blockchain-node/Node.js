...
initializeNode = function (serverHost, serverPort, blockchain) {
...
blockchain = new Blockchain(config.genesisBlock, config.startDifficulty);
initializeNode("localhost", 5001, blockchain);
node.startServer();
node.app = app;
