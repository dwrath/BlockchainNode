...
function SendTransaction() {
  ...
  return (
    <div>
      ...
      <section className="viewSendTransaction">
        <div className="form">
          <div>
            <span>Recipient:</span>
            <input type="text" size="25" id="recipientAddress" className="address" onChange={recipientHandler} />
          </div>
          <div>
            <span>Value: </span>
            <input type="number" className="transferValue" onChange={valueHandler} />
          </div>
          <div>
            <span>Fee: </span>
          ...
          <div>
            <span>Data: </span>
            <input type="text" size="25" className="tranData" onChange={dataHandler} />
          </div>
        </div>
        <textarea
